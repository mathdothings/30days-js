...
const whichAppearsMore = (array) => {
  ...
  aplhabet.forEach((letter) => {
    array.forEach((country) => {
      if (country.name.toLowerCase().indexOf(letter) === 0) {
        return total++;
      }
    });
    if (total > highest) {
  ...
  return [appersMore.toUpperCase(), highest];
};

console.log(whichAppearsMore(countries));
